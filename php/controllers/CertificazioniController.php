...
class CertificazioniController {
    ...
    public function update(Request $request, Response $response, $args){
        ...
        $mioID = $args["id"];
        $mysqli_connection = new MySQLi('my_mariadb', 'root', 'ciccio', 'scuola');
        $result = $mysqli_connection->query("UPDATE certificazioni SET titolo = '$titolo', votazione = '$votazione', ente = '$ente' WHERE id = $mioID");
    ...
    public function delete(Request $request, Response $response, $args){
        $mioID = $args["id"];
        $mysqli_connection = new MySQLi('my_mariadb', 'root', 'ciccio', 'scuola');
        $result = $mysqli_connection->query("DELETE FROM certificazioni WHERE id = $mioID");
